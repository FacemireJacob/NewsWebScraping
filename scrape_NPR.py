...
def scrape_article(url):
    ...
    text = soup.find_all(class_="storytext storylocation linkLocation")
    ...
    try:
        ...
        if conn.is_connected():
            ...
            for i in range (0, len(textAr)):
                #Build Query
                sqlQuery = "INSERT into " + table + " (Headline, Source, Link, Body) VALUES ('" + textAr[i][1]+"', 'NPR', '" + textAr[i][0] + "', '" + textAr[i][2] + "')"
                try:
